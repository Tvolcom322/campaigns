...
### Studies:
As students of the Spire, it is important to keep a grasp of your studies when you can. Using either the Library or books you obtain or check out, you can train skills in preperation for tests. In order to study a skill, it needs to be the only skill you work on for a full week, meaning you cannot switch the skill you start studying for 10 days.

You must accumulate 8 hrs worth of studying within a day, with a minimum of 2 straight hours for them to count. If you do not reach the 8 hour mark within a day, then half of your hours rounded down will carry over to the next day. When you successfully study for at least 8 hours within a day you gain a Study Point in the skill you have been studying. At 5 Study Points, you can attempt a d20 roll; if you roll an 18-20, you gain a Misc. +1 bonus to that skill. Whether successful or not, Study Points reset after an attempted roll.

The only 2 skills that are separate from this method of studying is Acrobatics and Athletics. These two skills can be trained in tandem with all the other skills within a week. You earn hours towards these skills by spending time in the Sparring Grounds, or by training in your environment.

While studying, you are not fully at rest despite it being reading, so you cannot benefit from a long or short rest. That being said you can only study a maximum of 12 hours in a day (for character realism sake of breaks). Characters can experience burnout from studying as well however. Every consecutive day spent studing past 3 raises a chance to have study efforts be ineffective. Each day past the third you need to roll a d20 and pass the DC for whatever number day is shown to a maximum of 7 days and then they must take a break. A break may not be spent to switch to training another skill or studying as the case may be.
...
Sometimes you can find rare oppurtunities or texts that can help further your normal studying method such as special lectures or rare texts.
...
| C     | Gain 1 Spire Credit                           |
| B     | Gain 2 Spire Credits                          |
| A     | Gain 3 Spire Credits                          |
